            ...
            <Card className="job-card">
                ...
                <CardContent>
                    <div className="job-details">
                        ...
                        <p><strong>Salary:</strong> {new Intl.NumberFormat('hu-HU', { style: 'currency', currency: 'HUF' }).format(job.salaryFrom)} - {new Intl.NumberFormat('hu-HU', { style: 'currency', currency: 'HUF' }).format(job.salaryTo)}</p>
